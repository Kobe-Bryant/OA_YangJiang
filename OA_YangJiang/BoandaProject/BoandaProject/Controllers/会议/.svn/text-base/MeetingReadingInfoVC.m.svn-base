...
@interface MeetingReadingInfoVC ()
...
@implementation MeetingReadingInfoVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0)
    {
        ...
        cell.textLabel.text = [NSString stringWithFormat:@"部门：%@    最近浏览人：%@    最近浏览日期：%@",[dic objectForKey:@"MC"],[dic objectForKey:@"UID"],[dic objectForKey:@"FKRQ"]];
