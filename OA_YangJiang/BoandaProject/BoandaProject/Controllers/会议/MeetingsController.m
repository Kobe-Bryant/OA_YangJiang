...
@implementation MeetingsController
...
- (void)modifyNavigationBar
{
    ...
    segmentControlTitles = [NSArray arrayWithObjects: @"所有会议",@"本周会议", nil];
    segmentCtrl = [[UISegmentedControl alloc] initWithItems:segmentControlTitles];
...
{
    SearchMeetingsViewController *childView = [[SearchMeetingsViewController alloc] initWithNibName:@"SearchMeetingsViewController" bundle:nil];
    childView.title = @"查询会议";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *yxjStr = [[itemAry objectAtIndex:indexPath.row] objectForKey:@"YXJMC"];
    if (!yxjStr)
    {
        yxjStr = @"";
    }
    ...
    NSString *fbsjStr = [[itemAry objectAtIndex:indexPath.row] objectForKey:@"CJSJ"];
    if (!fbsjStr)
    {
        fbsjStr = @"";
    }
