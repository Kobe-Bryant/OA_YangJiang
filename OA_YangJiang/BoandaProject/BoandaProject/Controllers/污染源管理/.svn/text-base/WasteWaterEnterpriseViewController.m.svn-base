//
//  WasteWaterEnterpriseViewController.m
//  BoandaProject
//
...
#import "WasteWaterEnterpriseViewController.h"

@interface WasteWaterEnterpriseViewController ()

@end

@implementation WasteWaterEnterpriseViewController
...
- (void)requestData
{
    ...
    [params setObject:@"QUERY_WATER_ENTERPRISE_LIST" forKey:@"service"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    detail.serviceName = @"Water_Online";
